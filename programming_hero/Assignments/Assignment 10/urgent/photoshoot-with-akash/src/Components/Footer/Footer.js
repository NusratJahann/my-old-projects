...
const Footer = () => {
    return (
        <footer className='bg-slate-900 pt-12 pb-3 text-white flex items-center flex-col'>
            ...
            <p className='mt-10'>©Copyright <a target="_blank" href="https://www.programming-hero.com/" className='underline'>programming-hero.com</a> 2022</p>
        </footer>
    );
};
