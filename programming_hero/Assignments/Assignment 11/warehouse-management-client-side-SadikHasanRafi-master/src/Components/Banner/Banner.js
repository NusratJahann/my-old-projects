        ...
        <div className='w-full relative'>
            ...
            <div>
                ...
                height: "80vh"}}>
                    ...
                    <Link to="*"><button className='bg-green-600 hover:bg-emerald-100 hover:text-slate-800 hover:border-2 hover:border-lime-500	 p-2 m-6 px-5 text-white text-xl '>Pre order</button></Link>
                    </div>
                </div>
            </div>
        </div>
