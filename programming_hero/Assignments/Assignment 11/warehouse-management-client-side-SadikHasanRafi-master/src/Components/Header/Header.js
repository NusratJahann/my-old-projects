...
const Header = () => {
    ...
    const {userName, googleSignOut} = useFirebase()
    ...
    return (
        <div>
            <nav className='flex justify-evenly p-7'>
                {/* logo */}
                <Link to='/'><li className='flex items-center list-none'> <span className="material-icons mr-3 text-green-500">warehouse</span>CPU House Management</li></Link>
